...
const App = () => {
  ...
  const hideSearchOn = ["/super-admin/students", "/super-admin/staff","/school-admin/students",, "/school-admin/staff"];
        ...
        <header className="flex items-center justify-between mb-8 sticky top-0 z-10 bg-slate-50/80 backdrop-blur-md py-4">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="w-11 h-11 bg-white border cursor-pointer border-slate-200 rounded-xl flex items-center justify-center text-slate-500 hover:text-red-600 transition-colors"
              title="Logout"
            >
              <LogOut size={20} />
            </button>

            <button className="relative w-11 h-11 bg-white border cursor-pointer border-slate-200 rounded-xl flex items-center justify-center text-slate-500 hover:text-indigo-600 transition-colors">
              <Bell size={20} />
